...
public class Application {
    ...
    public static void exerciseEight_NumberOfPets() {
        System.out.println("Exercise Eight - Number Of Pets");
    ...
    public static void exerciseEight_RatingOfLastMeal() {
        System.out.println("Exercise Eight - Rating Of Last Meal");
        // - Create a variable with a meaningful name to represent the idea and then assign it a number.
    ...
    public static void exerciseEight_HowManyDaysSinceLastGroceryTrip() {
        System.out.println("Exercise Eight - How Many Days Since Last Grocery Trip");
        // - Create a variable with a meaningful name to represent the idea and then assign it a number.
    ...
    public static void main(String[] args) {
        ...
        exerciseSeven();
        // ----------------------------------------------------------------------------------------------
        exerciseEight_NumberOfPets();
        // ----------------------------------------------------------------------------------------------
        exerciseEight_NumberOfPairsOfSunglasses();
        // ----------------------------------------------------------------------------------------------
        exerciseEight_RatingOfLastMeal();
        // ----------------------------------------------------------------------------------------------
        exerciseEight_HowManyDaysSinceLastGroceryTrip();
        ...
        Exercise Seven
        -3
        Exercise Eight - Number Of Pets
        2
        Exercise Eight - Number Of Pairs Of Sunglasses
        3
        Exercise Eight - Rating Of Last Meal
        9
        Exercise Eight - How Many Days Since Last Grocery Trip
        12
        */
    }
}
