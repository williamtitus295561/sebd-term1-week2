...
public class Application {
    ...
    public static void exerciseOne(int number) {
        ...
        if (number < 10) System.out.println("It is bigger than 10!");
    ...
    public static void exerciseTwo(String color) {
        ...
        if (color.equals ("blue")) System.out.println("The sky is blue.");
        if (color.equals ("red")) System.out.println("The flower is red.");
        else if (color.equals ("green")) System.out.println("The leaf is green.");
        else System.out.println("It is a different color.");
    ...
    public static void exerciseThree(int value) {
        ...
        public static void exerciseFour ( int number){
            ...
            //     (like: if (a && b) )
            if (number > 10 && number < 20) System.out.println("Between 10 and 20!");
            else if (number >= 20) System.out.println("20 or greater!");
            else if (number == 16) System.out.println("16!");
            else if (number >= 10) System.out.println("10 or less!");
            else System.out.println("The number is not between 10 and 20!");
        }
